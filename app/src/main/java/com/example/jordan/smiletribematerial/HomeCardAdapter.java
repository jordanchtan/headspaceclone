...
public class HomeCardAdapter extends RecyclerView.Adapter<HomeCardAdapter.ViewHolder> {
    ...
    public HomeCardAdapter(Context context, RecyclerViewClickListener itemListener, ArrayList<String> mDataset) {
        this.context = context;
        this.itemListener = itemListener;
        this.mDataset = mDataset;
    }

    public HomeCardAdapter(ArrayList<String> mDataset) {
        this.mDataset = mDataset;
    }
